...
export const RecruiterInsightsCard: React.FC<RecruiterInsightsCardProps> = ({ insights }) => {
  ...
  return (
    <div className="rounded-2xl border border-white/[0.08] bg-[#111114] p-4 sm:p-6 shadow-2xl space-y-4 sm:space-y-5 animate-fade-in">
      <div className="flex items-center space-x-2 border-b border-white/[0.06] pb-3">
        ...
        <h3 className="text-xs sm:text-sm font-semibold text-zinc-100">
          Executive Recruiter Strategy &amp; Observations
        </h3>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5 sm:gap-4">
        ...
        {insights.positioning_strategy && (
          <div className="rounded-xl border border-white/[0.06] bg-[#09090b] p-3.5 sm:p-4 space-y-2 md:col-span-2">
        ...
        {insights.interview_talking_points && insights.interview_talking_points.length > 0 && (
          <div className="rounded-xl border border-white/[0.06] bg-[#09090b] p-3.5 sm:p-4 space-y-2">
            <div className="flex items-center space-x-2 text-xs font-semibold text-zinc-200">
        ...
        {insights.risk_factors_or_gotchas && insights.risk_factors_or_gotchas.length > 0 && (
          <div className="rounded-xl border border-amber-500/20 bg-amber-950/20 p-3.5 sm:p-4 space-y-2">
